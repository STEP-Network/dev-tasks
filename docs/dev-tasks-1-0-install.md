...
```bash
bash ~/.claude/plugins/cache/dev-tasks-marketplace/dev-tasks/1.3.0/hooks/lib/profile.sh get profile
```
...
```bash
cd <consumer-project>
npx tsx ~/.claude/plugins/cache/dev-tasks-marketplace/dev-tasks/1.3.0/scripts/trackerctl.ts ready --limit 3
```
