...
echo "     routes on staging (chrome-devtools-mcp against environments.uat.url),"
echo "     call appendTaskVisualSnapshots({ taskId: $TASK_ID, phase: 'before', ... }),"
...
echo "     screenshot-reachable via chrome-devtools-mcp; capture there instead."
echo ""
