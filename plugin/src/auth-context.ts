...
export interface MondayAuthFrame {
  /** Monday personal API token or OAuth access token (used as the Authorization header on Monday GraphQL calls). */
  apiKey: string;
}

export const mondayAuthContext = new AsyncLocalStorage<MondayAuthFrame>();
